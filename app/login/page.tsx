               ...
               {clientId && (
                  <>
                     ...
                     <div className="group relative h-11">
                        {/* Visual button, styled to match the card */}
                        <div className="pointer-events-none absolute inset-0 flex items-center justify-center gap-2.5 rounded-lg border border-input bg-background text-sm font-medium text-foreground transition-colors group-hover:border-primary/60">
                           <GoogleG className="size-[18px]" />
                           Continue with Google
                        </div>
                        {/* Real Google Identity button, invisible, overlaid to capture the click */}
                        <div
                           ref={gbtn}
                           aria-hidden
                     ...
                     {gmsg && <p className="text-center text-xs text-destructive">{gmsg}</p>}
                  </>
               )}
